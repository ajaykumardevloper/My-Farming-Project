...
export default function page() {
  return (
    <>
     ...
     <span className="border-b-4 border-green-500"> FarmiTube</span>
            </h1>
            <p className="text-center mt-5">
            Grow Knowledge through Farming Videos
          </p>
      </div>
      <div className="my-20 mx-10  grid grid-cols-4 gap-14">
        ...
        <h1 className="font-bold text-2xl px-5 text-center">Crop Guide for Small-Scale Farmers</h1>
